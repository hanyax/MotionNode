...
def pca_process(data, data_num):
	...
	plt.tight_layout()
	plt.grid()
	plt.savefig('step4.png', dpi=300, format='png', bbox_inches='tight')
	plt.show()
...
def main():
	...
	data1 = load_6dim_data('/Users/kevin/Documents/UWEE/EE484-Sensor/data/goodpose-placement1/1/data4.txt')
	# data2 = load_6dim_data('../Data_output_txt_MotionShield/output_to_txt/badDataLower1.txt')
	data2 = load_6dim_data('/Users/kevin/Documents/UWEE/EE484-Sensor/data/goodpose-placement2/1/data4.txt')
	data3 = load_6dim_data('/Users/kevin/Documents/UWEE/EE484-Sensor/data/goodpose-placement3/1/data4.txt')
	data4 = load_6dim_data('/Users/kevin/Documents/UWEE/EE484-Sensor/data/goodpose-placement4/1/data4.txt')
